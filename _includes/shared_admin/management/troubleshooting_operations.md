...
For troubleshooting installations, see the <a href="{{site.baseurl}}/administration-guide/steps/troubleshooting_installations">Troubleshooting Installations</a> section.

For troubleshooting ontology submissions, see the <a href="{{site.baseurl}}/administration-guide/ontologies/troubleshooting_submissions">Troubleshooting Submissions</a> section.
...
To re-index an ontology, follow the instructions in [Search Index Management]({{site.baseurl}}/administration-guide/management/search_index_management)
...
See [ncbo-cron Reference]({{site.baseurl}}/administration-guide/management/ncbo_cron) for details.