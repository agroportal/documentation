...
For troubleshooting system operations, see the <a href="{{site.baseurl}}/administration-guide/management/troubleshooting_operations">Troubleshooting Operations</a> section.
...
(For a list of parseable ontology types, see [Parseable Ontologies]({{site.baseurl}}/administration-guide/ontologies/parseable_ontologies).)
