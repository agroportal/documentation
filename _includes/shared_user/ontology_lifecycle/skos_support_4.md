...
When examining [metric tables]({{ site.baseurl }}{% link docs/user-guide/documentation/ecoportal/platform_overview/ontology_details.md %}) within the {{ page.portal }} user interface, the "Number Of Individuals" value aligns with the count of concepts within a given SKOS vocabulary.
